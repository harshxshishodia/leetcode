...
<img alt="" src="../../../images/606-cons1-tree.jpg" style="padding: 10px; background: #fff; border-radius: .5rem;" />
<pre>
...
<img alt="" src="../../../images/606-cons2-tree.jpg" style="padding: 10px; background: #fff; border-radius: .5rem;" />
<pre>
