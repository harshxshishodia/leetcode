...
<img alt="" src="../../../images/3070-example1.png" style="padding: 10px; background: #fff; border-radius: .5rem;" />
<pre>
...
<img alt="" src="../../../images/3070-example21.png" style="padding: 10px; background: #fff; border-radius: .5rem;" />
<pre>
